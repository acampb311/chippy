...
final class Chip8Tests: XCTestCase {
   ...
   func testXOR() throws {
    ...
    func testLoadIntoRegister() throws {
       ...
       // Then
       XCTAssertEqual(chip8.registers.array[14], 0xFF)
    }
    ...
    func testSkipNextInstrEqual() throws {
       ...
       chip8.registers.array = [0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA]
    ...
    func testSkipNextInstrRegistersEqual() throws {
       ...
       chip8.registers.array = [0x00, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA]
    ...
    func testStoreXinY() throws {
       ...
       // Then
       XCTAssertEqual(chip8.registers.array, [0xAA, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA])
    }
    ...
    func testXOrY() throws {
       ...
       chip8.registers.array = [0b11110000, 0b00110011, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA]

       // When
       try OR(opcode: Opcode(instruction: 0x8011), chip: &chip8)
       
       // Then
       XCTAssertEqual(chip8.registers.array, [0b11110011, 0b00110011, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA])
    }
    ...
    func testXAndY() throws {
       ...
       // Then
       XCTAssertEqual(chip8.registers.array, [0b00110000, 0b00110011, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA])
    }
    ...
    func testXXorY() throws {
       ...
       // Then
       XCTAssertEqual(chip8.registers.array, [0b11000011, 0b00110011, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA])
    }
    ...
    func testXAddRY() throws {
       ...
       chip8.registers.array = [0x00, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]

       // When
       try ADDR(opcode: Opcode(instruction: 0x8014), chip: &chip8)
       
       // Then
       XCTAssertEqual(chip8.registers.array, [0xAA, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])
       
       // Given
       chip8.registers.array = [0xAA, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]

       // When
       try ADDR(opcode: Opcode(instruction: 0x8014), chip: &chip8)
       
       // Then
       XCTAssertEqual(chip8.registers.array, [0x54, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01])
    }
    ...
    func testXSubRY() throws {
       ...
       // Then
       XCTAssertEqual(chip8.registers.array, [0x56, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])
       
       // Given
       chip8.registers.array = [0xFF, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]

       // When
       try SUB(opcode: Opcode(instruction: 0x8015), chip: &chip8)
       
       // Then
       XCTAssertEqual(chip8.registers.array, [0x55, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01])
    }
    ...
    func testXSHRY() throws {
       ...
       chip8.registers.array = [0b00000111, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]

       // When
       try SHR(opcode: Opcode(instruction: 0x8016), chip: &chip8)
       
       // Then
       XCTAssertEqual(chip8.registers.array, [0b00000011, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01])
       
       // Given
       chip8.registers.array = [0b00000110, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]

       // When
       try SHR(opcode: Opcode(instruction: 0x8016), chip: &chip8)
       
       // Then
       XCTAssertEqual(chip8.registers.array, [0b00000011, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])
    }
    ...
    func testXSubNY() throws {
       ...
       // Then
       XCTAssertEqual(chip8.registers.array, [0xAA, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01])
       ...
       // Then
       XCTAssertEqual(chip8.registers.array, [0xAB, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])
    }
    ...
    func testXSHLY() throws {
       ...
       chip8.registers.array = [0b10000111, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]

       // When
       try SHL(opcode: Opcode(instruction: 0x801E), chip: &chip8)
       
       // Then
       XCTAssertEqual(chip8.registers.array, [0b00001110, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01])
       ...
       // Then
       XCTAssertEqual(chip8.registers.array, [0b00001100, 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])
    }
    ...
    func testSkipNextInstrRegNotEqual() throws {
       ...
       // Given
       chip8.registers.array = [0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA]
    ...
    func testJumpToLocationWithReg() throws {
       ...
       chip8.registers.array = [0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA]
    ...
    func testSetVxToDelayTimer() throws {
       ...
       // Then
       XCTAssertEqual(chip8.registers.array, [0x45, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA])
    }
    ...
    func testAddIandReg() throws {
       ...
       chip8.registers.array = [0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA]
    ...
    func testBinaryCodedDecimal() throws {
       ...
       chip8.registers.array = [245, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA]
    ...
    func testStoreRegistersInMemory() throws {
       ...
       chip8.registers.array = [0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F]
    ...
    func testLoadMemoryIntoRegisters() throws {
       ...
       // Then
       XCTAssertEqual(chip8.registers.array, [0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F])
    }
}
